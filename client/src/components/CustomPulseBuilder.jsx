  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Create Custom Pulse" size="md">
      <div className="space-y-5">
        ...
        {/* Error */}
        {error && (
          <div className="p-2.5 rounded-lg bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800 text-xs font-medium text-rose-600 dark:text-rose-300">
            {error}
          </div>
        )}
