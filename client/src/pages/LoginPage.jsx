      ...
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="bg-white rounded-xl p-7 sm:p-8 border border-slate-200/90 shadow-xs">
          ...
          <div className="text-center mb-6">
            ...
            <h1 className="text-xl font-bold text-slate-900 tracking-tight">Sign in to PulseClass</h1>
            <p className="text-xs text-slate-500 mt-1">Real-time classroom engagement platform</p>
          </div>
          ...
          <div className="mt-5 pt-4 border-t border-slate-100 text-center">
            <span className="text-[11px] text-slate-400 font-medium block mb-2">Demo Credentials</span>
            <div className="flex items-center justify-center gap-2">
              <button
                type="button"
                onClick={() => fillDemo('instructor')}
                className="px-2 py-1 rounded bg-slate-100 hover:bg-slate-200 text-[11px] font-semibold text-slate-700 cursor-pointer transition-colors"
              >
                Instructor
              </button>
              <button
